...
public final class  DoiLichDuongSangAm {

    private DoiLichDuongSangAm() {
    }

    public static DoiLichDuongSangAm instance;

    public static DoiLichDuongSangAm getInstance() {
        if (instance == null) {
            instance = new DoiLichDuongSangAm();
        }
        return instance;
    }
    ...
    public String getLunarMonth(int lunarMonth, int lunarYear){
        ...
        int mod = (lunarYear*12+ lunarMonth+3)%10;
        return can[mod]+" "+chi[lunarMonth-1];
    }
}
