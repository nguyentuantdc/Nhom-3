    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        btnTinh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tvChiSo.setText(String.valueOf(canNang / (chieuCao * chieuCao) * 10000));

                if (Float.parseFloat(tvChiSo.getText().toString()) < 18) {
                    tvDanhGia.setText("Bạn hơi gầy");
                }

                else if (Float.parseFloat(tvChiSo.getText().toString()) < 25) {
                    tvDanhGia.setText("Bạn bình thường");
                }

                else if (Float.parseFloat(tvChiSo.getText().toString()) >25 || (Float.parseFloat(tvChiSo.getText().toString()) < 30)) {
                    tvDanhGia.setText("Bạn béo phì cấp độ 1");
                }

                else if (Float.parseFloat(tvChiSo.getText().toString()) > 30 || (Float.parseFloat(tvChiSo.getText().toString()) < 35)) {
                    tvDanhGia.setText("Bạn béo phì cấp độ 2");
                }

                else if (Float.parseFloat(tvChiSo.getText().toString()) > 35) {
                    tvDanhGia.setText("Bạn béo phì cấp độ 3");
                }
                else
                {
                    tvDanhGia.setText("Không xác định được");
                }
