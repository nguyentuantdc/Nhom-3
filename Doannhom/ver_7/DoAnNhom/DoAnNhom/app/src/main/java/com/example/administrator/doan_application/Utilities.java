...
public class Utilities {
    ...
    /**
     * Hàm trả về thứ trong tuần của ngày truyền vào
     * @param Day ngày truyền vào
     * @param Month tháng truyền vào
     * @param Year năm truyền vào
     * @return Trả về số nguyên từ 0 - 6 tương ứng Sunday - Saturday
     */
