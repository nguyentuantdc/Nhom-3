...
public class TaoBaoThucActivity extends AppCompatActivity{
    ...
    public static final String EXTRA_GIOBAOTHUC = "EXTRA_GIOBAOTHUC";
    public static final String EXTRA_PHUTBAOTHUC = "EXTRA_PHUTBAOTHUC";
    public static final String EXTRA_GHICHUBAOTHUC = "EXTRA_GHICHUBAOTHUC";
    public static final String EXTRA_CHUONGBAOTHUC = "EXTRA_CHUONGBAOTHUC";
...
//    }
        ...
        btnAdd.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (isTaoBaoThuc)
                {
                    ...
                    Intent intent = new Intent();
                    intent.putExtra(BaoThucFragment.EXTRA_BAOTHUCMOI, (Parcelable) baoThuc);
                ...
                else // ngược lại là sửa báo thức
                {
                    ...
                    setAlarm(selectedBaoThuc);

                    // trở lại màn hình chính
                    Intent intent = new Intent();
                    intent.putExtra(BaoThucFragment.EXTRA_SUABAOTHUC, (Parcelable) selectedBaoThuc);
                    setResult(Activity.RESULT_OK, intent);
    ...
    private  void setAlarm(BaoThuc baoThuc){
        Calendar calendar = Calendar.getInstance();
        calendar.set(Calendar.HOUR_OF_DAY, timeHour);
        calendar.set(Calendar.MINUTE, timeMinute);

        final Intent intent = new Intent(TaoBaoThucActivity.this, HenBaoThucActivity.class);

        intent.putExtra(EXTRA_GIOBAOTHUC, timeHour);
        intent.putExtra(EXTRA_PHUTBAOTHUC, timeMinute);
        intent.putExtra(EXTRA_GHICHUBAOTHUC, edt_mota.getText().toString());
        intent.putExtra(EXTRA_CHUONGBAOTHUC, baoThuc.getsChuongBao().getsDuongDan());

        Log.e("gio bao thuc: ", timeHour + ":" + timeMinute);

        baoThuc.setAlarmManager((AlarmManager) getSystemService(ALARM_SERVICE));

        PendingIntent pendingIntent = PendingIntent.getActivity(TaoBaoThucActivity.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
    ...
    public void setTime(View view){
        ...
        timePickerDialog = new TimePickerDialog(this, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                ...
                Log.e("Time selected: ", timeHour + ":" + timeMinute);
